package me.temp.samples.osgi.cxf.osgi.cxf.wssec_ut.greeter.provider;

import javax.xml.ws.BindingProvider;
import javax.xml.ws.Endpoint;

import me.temp.samples.osgi.cxf.wssec_ut.greeter.provider.GreeterImpl;
...
public class ProviderTest extends Assert {
    ...
    public void testServices() throws Exception {
        GreeterService service = new GreeterService(GreeterService.class.getResource("/wsdl/hello_world_wssec.wsdl"));
        ...
        String me = greeter.greetMe("WSSUtanna");
        System.out.println("said: " + me);
        assertEquals("Hello WSSUtanna", me);
    }
}
